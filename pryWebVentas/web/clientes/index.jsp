...
<body>
    ...
    <div class="container-xl">
        ...
        <a href="ClientesController?accion=nuevo" class="btn btn-primary mb-3">
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    <c:forEach var="cli" items="${listaClientes}">
                        <tr>
                            <td class="text-center"><c:out value="${cli.idcliente}" /></td>
                            <td class="text-center"><c:out value="${cli.clnombre}" /></td>
                            <td class="text-center"><c:out value="${cli.clapellido}" /></td>
                            <td class="text-center"><c:out value="${cli.clDNI}" /></td>
                            <td class="text-center"><c:out value="${cli.cltelefono}" /></td>
                            <td class="text-center"><c:out value="${cli.clcorreo}" /></td>
                            <td class="text-center"><c:out value="${cli.cldireccion}" /></td>
                            <td class="text-center">
                                <a href="ClientesController?accion=modificar&txtIDCli=<c:out value='${cli.idcliente}'/>" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i> Modificar
                                </a>
                                <a href="ClientesController?accion=eliminar&txtIDCli=<c:out value='${cli.idcliente}'/>" class="btn btn-danger btn-sm">
